...
type AccessSelectionIndexRange struct {
	code             []byte
	tag              *BerTag
	lowIndex         *Unsigned32
...
func (r *AccessSelectionIndexRange) encode(reverseOS *ReverseByteArrayOutputStream, withTag bool) int {
	if r.code != nil {
...
func (r *AccessSelectionIndexRange) decode(is *bytes.Buffer, withTag bool) int {
...
func NewAccessSelectionIndexRange() *AccessSelectionIndexRange {
	return &AccessSelectionIndexRange{}
}
