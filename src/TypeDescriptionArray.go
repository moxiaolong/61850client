...
type TypeDescriptionArray struct {
	tag              *BerTag
	packed           *BerBoolean
...
func (a *TypeDescriptionArray) decode(is *bytes.Buffer, withTag bool) int {
	tlByteCount := 0
	vByteCount := 0
...
func (a *TypeDescriptionArray) encode(reverseOS *ReverseByteArrayOutputStream, withTag bool) int {
	if a.code != nil {
...
func NewTypeDescriptionArray() *TypeDescriptionArray {
	return &TypeDescriptionArray{tag: NewBerTag(0, 32, 16)}
}
